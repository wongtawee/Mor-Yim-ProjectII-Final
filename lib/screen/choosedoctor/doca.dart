...
class Doca extends StatefulWidget {
  final String title;
  final String hint;
  final TextEditingController controller;
  final Widget widget;
  const Doca({Key key, this.title, this.hint, this.controller, this.widget})
      : super(key: key);

  @override
  _DocaState createState() => _DocaState();
}

class _DocaState extends State<Doca> {
